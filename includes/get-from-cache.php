...
Class Dude_Img_User_Feed_Get_From_Cache extends Dude_Img_User_Feed {
    ...
    $count = apply_filters( "dude_img_userfeed_insta_count_{$username}", $count );
	  ...
	  if ( ! $insta ) {
	    $insta = Dude_Img_User_Feed_Fetch_Instagram::do_fetch( $username );
	  }
...
} // end class Dude_Img_User_Feed_Get_From_Cache
